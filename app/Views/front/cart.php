            ...
            <div class="card card-custom gutter-b">
              ...
              <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <h3 class="card-title align-items-start flex-column">
                  <span class="card-label font-weight-bolder font-size-h3 text-dark"> <label for="">
                      <h2>Toko : <?= $rows->nama ?></h2>
                    </label></span>
                </h3>
                ...
                <div class="table-responsive ">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <!--begin::Cart Content-->
                      <?php
                      $cariproduk = $db->table('keranjang_produk')->join('produk', 'id_produk=produk_id')->join('users', 'produk_user_id=id_user')->where('keranjang_id', $rows->id_keranjang)->get()->getResult();
                      foreach ($cariproduk as $row) {
                      ?>
                        <tr>
                      ...
                      <?php
                        @$total[$rows->id_keranjang] = @$total[$rows->id_keranjang] + ($row->harga * $row->jumlah);
                      }
                      ?>
                      ...
                      <tr>
                        ...
                        <td class="font-weight-bolder font-size-h4 text-right">Rp. <?= number_format(@$total[$rows->id_keranjang]) ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td colspan="2" class="border-0 text-right pt-10">
                          <a href="<?= BASE ?>/front/checkout/<?= $rows->id_keranjang ?>" class="btn btn-success font-weight-bolder px-8">Proceed to Checkout</a>
                        </td>
                      </tr>
                      <!--end::Cart Footer-->
                    </tbody>
